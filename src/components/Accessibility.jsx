      ...
      <ul className="accessilibity-option">
        <li>
          <button className="acc-option-btn">
            <svg
              className="acc-option-icon ear-icon"
              version="1.1"
              id="_x32_"
            ...
            >
              <g>
                <path
                  d="M460.292,450.719l-0.905-0.095c0.08,0.072-0.667,2.741-3.163,5.959c-3.671,4.902-10.694,10.964-19.68,15.398
		...
		c4.72-6.857,8.263-14.388,8.374-23.589H460.292z"
                />
                <path
                  d="M392.036,257.033c-11.394,2.121-21.778,8.613-28.928,18.345c-7.206,9.726-11.187,22.477-11.17,37.001
		...
		c2.216-0.421,4.425-0.627,6.594-0.627c8.096,0.015,15.596,2.812,21.436,8.096C430.426,293.795,434.852,301.645,436.115,313.109z"
                />
                <path
                  d="M148.621,156.83c-3.385-5.825-10.853-7.802-16.677-4.402c-5.832,3.392-7.794,10.853-4.41,16.685
		...
		c5.991,3.107,13.348,0.795,16.463-5.188c28.682-55.076,32.233-122.601,3.638-183C154.437,167.19,151.576,161.906,148.621,156.83z"
                />
                <path
                  d="M96.096,183.358c-3.393-5.824-10.862-7.802-16.693-4.418c-5.824,3.401-7.794,10.87-4.418,16.693
		...
		"
                />
                <path
                  d="M46.844,215.901c-1.32-2.781-2.718-5.236-4.005-7.469c-3.384-5.832-10.853-7.818-16.685-4.441
        ...
        <li>
          <button className="acc-option-btn">
            <svg
              className="acc-option-icon eye-icon"
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
              viewBox="0 0 576 512"
        ...
        <li>
          <button className="acc-option-btn">
            <svg
              className="acc-option-icon text-icon"
              strokeWidth="0"
              viewBox="0 0 16 16"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M3.36 7L1 13h1.34l.51-1.47h2.26L5.64 13H7L4.65 7H3.36zm-.15 3.53l.78-2.14.78 2.14H3.21zM11.82 4h-1.6L7 13h1.56l.75-2.29h3.36l.77 2.29H15l-3.18-9zM9.67 9.5l1.18-3.59c.059-.185.1-.376.12-.57.027.192.064.382.11.57l1.25 3.59H9.67z"></path>
            </svg>
            Large Text
          </button>
        </li>
